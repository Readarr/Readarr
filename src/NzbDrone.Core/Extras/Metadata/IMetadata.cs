...
namespace NzbDrone.Core.Extras.Metadata
{
    ...
    {
        string GetFilenameAfterMove(Author artist, TrackFile trackFile, MetadataFile metadataFile);
        ...
        MetadataFileResult TrackMetadata(Author artist, TrackFile trackFile);
        ...
        List<ImageFileResult> TrackImages(Author artist, TrackFile trackFile);
    }
}
