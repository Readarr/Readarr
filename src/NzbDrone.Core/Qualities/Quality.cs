...
namespace NzbDrone.Core.Qualities
{
    public class Quality : IEmbeddedDocument, IEquatable<Quality>
    {
        ...
        public static Quality MOBI => new Quality(1, "MOBI");
        public static Quality EPUB => new Quality(2, "EPUB");
        public static Quality AZW3 => new Quality(3, "AZW3");
        public static Quality MP3_320 => new Quality(4, "MP3-320");
        public static Quality FLAC => new Quality(5, "FLAC");
        ...
        static Quality()
        {
            ...
            DefaultQualityDefinitions = new HashSet<QualityDefinition>
            {
                ...
                new QualityDefinition(Quality.MOBI)        { Weight = 10, MinSize = 0, MaxSize = 350, GroupWeight = 2 },
                new QualityDefinition(Quality.EPUB)        { Weight = 11, MinSize = 0, MaxSize = 350, GroupWeight = 3 },
                new QualityDefinition(Quality.AZW3)        { Weight = 12, MinSize = 0, MaxSize = 350, GroupWeight = 4 },
                new QualityDefinition(Quality.MP3_320)     { Weight = 100, MinSize = 0, MaxSize = 350, GroupWeight = 5 },
                new QualityDefinition(Quality.FLAC)        { Weight = 110, MinSize = 0, MaxSize = null, GroupWeight = 6 },
            };
        }
