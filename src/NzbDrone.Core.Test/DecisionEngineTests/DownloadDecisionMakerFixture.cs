...
namespace NzbDrone.Core.Test.DecisionEngineTests
{
    ...
    public class DownloadDecisionMakerFixture : CoreTest<DownloadDecisionMaker>
    {
        ...
        public void should_return_rejected_result_for_unparsable_search()
        {
            ...
            var artist = new Author { Name = "Some Artist" };
            var albums = new List<Book> { new Book { Title = "Some Album" } };

            Subject.GetSearchDecision(_reports, new BookSearchCriteria { Author = artist, Books = albums }).ToList();
