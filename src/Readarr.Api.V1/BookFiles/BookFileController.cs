...
namespace Readarr.Api.V1.BookFiles
{
                                 ...
                                 IHandle<BookFileDeletedEvent>
    {
        ...
        [HttpGet]
        public List<BookFileResource> GetBookFiles(int? authorId, [FromQuery]List<int> bookFileIds, [FromQuery]List<int> bookIds, bool? unmapped)
        {
            if (!authorId.HasValue && bookFileIds == null && bookIds == null && !unmapped.HasValue)
            {
            ...
            if (authorId.HasValue && bookIds == null)
            {
